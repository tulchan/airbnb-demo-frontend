...
export default () => (
  <div className="row">
    ...
    <div className="col-xs-12 col-sm-6">
      <CardWrapper
        img={image2}
        descr="Your private 3 bedr, riad and exclusive"
        price={82}
        layout="Entire house"
        beds="5 beds"
        reviews={161}
    ...
    <div className="col-xs-12 col-sm-6">
      <CardWrapper
        img={image1}
        descr="Best location old town luxury loft"
        price={110}
        layout="Entire apartment"
        beds="1 bed"
        reviews={369}
        review="Superhost"
      />
    ...
    <div className="col-xs-12 col-sm-6">
      <CardWrapper
        img={image2}
        descr="Lussuosom Vista incantevole"
        price={83}
        layout="Entire apartment"
        beds="6 beds"
        reviews={105}
    ...
    <div className="col-xs-12 col-sm-6">
      <CardWrapper
        img={image3}
        descr="In the historical center of Lecce"
        price={72}
        layout="Entire house"
        beds="3 beds"
        reviews={221}
